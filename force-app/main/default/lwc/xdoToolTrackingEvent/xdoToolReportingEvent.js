...
export default class XdoToolReportingEvent extends XdoToolBaseEvent {
  constructor(componentName, event, data) {
    ...
    this.setType(TYPE_ENUM().REPORTING).setEvent(event).setLocalProps(data);
  }

  static conversion(componentName, data) {
    return new XdoToolReportingEvent(
      componentName,
      EVENT_ENUM().REPORTING.CONVERSION,
      data
    );
  }
