...
export default class XdoToolProductDevelopmentEvent extends XdoToolBaseEvent {
  constructor(componentName, event, data) {
    ...
    this.setType(TYPE_ENUM().PRODUCT).setEvent(event).setLocalProps(data);
  }

  static apiCalled(componentName, data) {
    return new XdoToolProductDevelopmentEvent(
      componentName,
      EVENT_ENUM().PRODUCT.API_CALLED,
      data
    );
  }
  ...
  static assetInstalled(componentName, data) {
    return new XdoToolProductDevelopmentEvent(
      componentName,
      EVENT_ENUM().PRODUCT.ASSET_INSTALLED,
      data
    );
  }
  ...
  static assetViewed(componentName, data) {
    return new XdoToolProductDevelopmentEvent(
      componentName,
      EVENT_ENUM().PRODUCT.ASSET_VIEWED,
      data
    );
  }
  ...
  static elementClicked(componentName, data) {
    return new XdoToolProductDevelopmentEvent(
      componentName,
      EVENT_ENUM().PRODUCT.ELEMENT_CLICKED,
      data
    );
  }
  ...
  static elementHovered(componentName, data) {
    return new XdoToolProductDevelopmentEvent(
      componentName,
      EVENT_ENUM().PRODUCT.ELEMENT_HOVERED,
      data
    );
  }
  ...
  setLocalProps(data) {
    this.properties.push(
      new XdoToolBaseEventProperty("element_type", data["trackingElementType"])
    );
    this.properties.push(
      new XdoToolBaseEventProperty(
        "element_label",
        data["trackingElementLabel"]
      )
    );
    this.properties.push(
      new XdoToolBaseEventProperty(
        "element_value",
        data["trackingElementValue"]
      )
    );
