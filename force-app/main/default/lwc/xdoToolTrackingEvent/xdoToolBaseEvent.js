...
class XdoToolBaseEvent {
  ...
  constructor(componentName, data) {
    ...
    this.setAttributes(data).setProps(data).setAssetIdentifier(componentName);
  }
  ...
  setProps(data) {
    this.properties.push(
      new XdoToolBaseEventProperty("action", data["trackingAction"])
    );
    this.properties.push(
      new XdoToolBaseEventProperty("dom_event", data["trackingDomEvent"])
    );
    this.properties.push(
      new XdoToolBaseEventProperty("page", window.location.href)
    );
    this.properties.push(
      new XdoToolBaseEventProperty("source", data["trackingSource"])
    );
    this.properties.push(
      new XdoToolBaseEventProperty("value", data["trackingValue"])
    );
  ...
  setAssetIdentifier(value) {
    ...
    this.properties.push(
      new XdoToolBaseEventProperty("asset_identifier", this.asset_identifier)
    );
...
export { TYPE_ENUM, EVENT_ENUM, XdoToolBaseEventProperty, XdoToolBaseEvent };
